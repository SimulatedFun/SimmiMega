...
class GameObject {
	public:
		...
		/// background
		boo isHighlighted() {
			return Bits::testBit(data.logic, SPRITE_COLOR_PALETTE);
		}
		...
		boolean isAnimated() {
			return Bits::testBit(data.logic, SPRITE_IS_ANIMATED);
		}
		...
		boolean startsOnFrameTwo() {
			return Bits::testBit(data.logic, SPRITE_STARTS_ON_FRAME_TWO);
		}

		/// What is the movement type of this object? Options: [target player / wander / still]
		u8 initialMovementType() {
			const u8 value = Bits::getBits(data.logic, INITIAL_MOVEMENT_TYPE, VALUES_4);
			return value;
		}
		...
		boolean isSolid() {
			return Bits::testBit(data.logic, TOUCH_IS_SOLID);
		}
		...
		boolean touchTriggersFlag() {
			return Bits::testBit(data.logic, TOUCH_TRIGGERS_FLAG);
		}
		...
		u8 touchTriggersFlagId() {
			const u8 flagId = Bits::getBits(data.logic, TOUCH_TRIGGERS_FLAG_ID, flagIdSize);
			if (flagId >= flagCount) {
				return _NO_FLAG;
			}
			return flagId;
		...
		boolean touchFlipsFlag() {
			return Bits::testBit(data.logic, TOUCH_FLIPS_FLAG);
		}
		...
		boolean touchSetsFlagTo() {
			return Bits::testBit(data.logic, TOUCH_SETS_FLAG_TO);
		}
		...
		boolean touchTeleportsToRoom() {
			return Bits::testBit(data.logic, TOUCH_TELEPORTS_TO_ROOM);
		}
		...
		u8 touchTeleportsToRoomId() {
			const u8 roomId = Bits::getBits(data.logic, TOUCH_TELEPORTS_TO_ROOM_ID, roomIdSize);
			if (roomId > roomCount) {
		...
		u8 touchTeleportsToRoomX() {
			const u8 xValue = Bits::getBits(data.logic, TOUCH_TELEPORTS_TO_ROOM_X, VALUES_16);
			if (xValue >= 13) {
				return 0;
			}
			return xValue;
		...
		u8 touchTeleportsToRoomY() {
			const u8 yValue = Bits::getBits(data.logic, TOUCH_TELEPORTS_TO_ROOM_Y, VALUES_16);
			if (yValue >= 10) {
				return 0;
			}
			return yValue;
		...
		boolean touchTeleportRequiresFlag() {
			return Bits::testBit(data.logic, TOUCH_TELEPORT_REQUIRES_FLAG);
		}

		/// Teleportation may only occur when this flag is set to a certain value
		/// \return the flag id
		u8 touchTeleportRequiresFlagId() {
			const u8 flagId = Bits::getBits(data.logic, TOUCH_TELEPORT_REQUIRES_FLAG_ID, flagIdSize);
			if (flagId >= flagCount) {
				return _NO_FLAG;
			}
			return flagId;
		...
		boolean touchTeleportRequiresFlagSetTo() {
			return Bits::testBit(data.logic, TOUCH_TELEPORT_REQUIRES_FLAG_SET_TO);
		}
		...
		boolean touchShowsDialog() {
			return Bits::testBit(data.logic, TOUCH_SHOWS_DIALOG);
		}

		/// If the object shows a dialog box, what is the dialog box id?
		/// \return the dialog box id
		u8 touchDialogId() {
			const u8 dialogId = Bits::getBits(data.logic, TOUCH_SHOWS_DIALOG_ID, dialogIdSize);
		...
		boolean dialogRequiresFlag() {
			return Bits::testBit(data.logic, TOUCH_SHOWS_DIALOG_REQUIRES_FLAG);
		}

		/// If the object requires a flag to show a dialog box, what is the flag id?
		/// \return the flag id
		u8 dialogRequiresFlagId() {
			const u8 flagId = Bits::getBits(data.logic, TOUCH_SHOWS_DIALOG_REQUIRES_FLAG_ID, flagIdSize);
			if (flagId >= flagCount) {
				return _NO_FLAG;
			}
			return flagId;
		...
		boolean dialogRequiresFlagSetTo() {
			return Bits::testBit(data.logic, TOUCH_SHOWS_DIALOG_REQUIRES_FLAG_SET_TO);
		}
		...
		u8 updateOnFlagId() {
			const u8 flagId = Bits::getBits(data.logic, UPDATE_ON_FLAG_ID, flagIdSize);
			if (flagId >= flagCount) {
				return _NO_FLAG;
			}
			return flagId;
		...
		boolean updateOnFlagSetTo() {
			return Bits::testBit(data.logic, UPDATE_ON_FLAG_SET_TO);
		}
		...
		boolean updateAffectsSolidity() {
			return Bits::testBit(data.logic, UPDATE_SETS_SOLID);
		}
		...
		boolean updateSetsSolidityTo() {
			return Bits::testBit(data.logic, UPDATE_SETS_SOLID_TO);
		}
		...
		boolean updateAffectsFrame() {
			return Bits::testBit(data.logic, UPDATE_AFFECTS_FRAME);
		}
		...
		boolean updateSetsFrameTo() {
			return Bits::testBit(data.logic, UPDATE_SETS_FRAME_TO);
		}
		...
		boolean updateAffectsAnimated() {
			return Bits::testBit(data.logic, UPDATE_AFFECTS_ANIMATED);
		}
		...
		boolean updateSetsAnimatedTo() {
			return Bits::testBit(data.logic, UPDATE_SETS_ANIMATED_TO);
		}
		...
		boolean updateReplacesWithGameObject() {
			return Bits::testBit(data.logic, UPDATE_DISPLACES);
		}
		...
		uint16_t updateReplacesWithGameObjectId() {
			const uint16_t objectId = Bits::getBits(data.logic, UPDATE_DISPLACES_WITH_ID, objectIdSize);
		...
		boolean updateAffectsMovement() {
			return Bits::testBit(data.logic, UPDATE_AFFECTS_MOVEMENT_TYPE);
		}

		u8 updateSetsMovementTo() {
			return Bits::getBits(data.logic, UPDATE_SETS_MOVEMENT_TYPE_TO, VALUES_4);
		}

		// Setters
		void set_IsHighlighted(boolean value) {
			Bits::setBit(data.logic, SPRITE_COLOR_PALETTE, value);
		}

		void set_isAnimated(boolean value) {
			Bits::setBit(data.logic, SPRITE_IS_ANIMATED, value);
		} // is the object animated?

		void set_startsOnFrameTwo(boolean value) {
			Bits::setBit(data.logic, SPRITE_STARTS_ON_FRAME_TWO, value);
		...
		void set_initialMovementType(u8 value) {
			...
			Bits::setBits(data.logic, INITIAL_MOVEMENT_TYPE, VALUES_4, value);
		}

		void set_isSolid(boolean value) {
			Bits::setBit(data.logic, TOUCH_IS_SOLID, value);
		} // is the object solid and does it trigger collision code?

		void set_touchTriggersFlag(boolean value) {
			Bits::setBit(data.logic, TOUCH_TRIGGERS_FLAG, value);
		}

		void set_touchTriggersFlagId(u8 value) {
			Bits::setBits(data.logic, TOUCH_TRIGGERS_FLAG_ID, flagIdSize, value);
		}

		void set_touchFlipsFlag(boolean value) {
			Bits::setBit(data.logic, TOUCH_FLIPS_FLAG, value);
		}

		void set_touchSetsFlagTo(boolean value) {
			Bits::setBit(data.logic, TOUCH_SETS_FLAG_TO, value);
		}

		void set_touchTeleportsToRoom(boolean value) {
			Bits::setBit(data.logic, TOUCH_TELEPORTS_TO_ROOM, value);
		}

		void set_touchTeleportsToRoomId(u8 value) {
			Bits::setBits(data.logic, TOUCH_TELEPORTS_TO_ROOM_ID, roomIdSize, value);
		}

		void set_touchTeleportsToRoomX(u8 value) {
			Bits::setBits(data.logic, TOUCH_TELEPORTS_TO_ROOM_X, VALUES_16, value);
		}

		void set_touchTeleportsToRoomY(u8 value) {
			Bits::setBits(data.logic, TOUCH_TELEPORTS_TO_ROOM_Y, VALUES_16, value);
		}

		void set_touchTeleportRequiresFlag(boolean value) {
			Bits::setBit(data.logic, TOUCH_TELEPORT_REQUIRES_FLAG, value);
		}

		void set_touchTeleportRequiresFlagId(u8 value) {
			Bits::setBits(data.logic, TOUCH_TELEPORT_REQUIRES_FLAG_ID, flagIdSize, value);
		}

		void set_touchTeleportRequiresFlagSetTo(boolean value) {
			Bits::setBit(data.logic, TOUCH_TELEPORT_REQUIRES_FLAG_SET_TO, value);
		}

		void set_touchShowsDialog(boolean value) {
			Bits::setBit(data.logic, TOUCH_SHOWS_DIALOG, value);
		}

		void set_touchShowsDialogId(u8 value) {
			Bits::setBits(data.logic, TOUCH_SHOWS_DIALOG_ID, dialogIdSize, value);
		}

		void set_touchShowsDialogRequiresFlag(boolean value) {
			Bits::setBit(data.logic, TOUCH_SHOWS_DIALOG_REQUIRES_FLAG, value);
		}

		void set_touchShowsDialogRequiresFlagId(u8 value) {
			Bits::setBits(data.logic, TOUCH_SHOWS_DIALOG_REQUIRES_FLAG_ID, flagIdSize, value);
		}

		void set_touchShowsDialogRequiresFlagSetTo(boolean value) {
			Bits::setBit(data.logic, TOUCH_SHOWS_DIALOG_REQUIRES_FLAG_SET_TO, value);
		}

		void set_updateOnFlagId(u8 value) {
			Bits::setBits(data.logic, UPDATE_ON_FLAG_ID, flagIdSize, value);
		}

		void set_updateOnFlagSetTo(boolean value) {
			Bits::setBit(data.logic, UPDATE_ON_FLAG_SET_TO, value);
		}

		void set_updateAffectsSolidity(boolean value) {
			Bits::setBit(data.logic, UPDATE_SETS_SOLID, value);
		}

		void set_updateSetsSolidityTo(boolean value) {
			Bits::setBit(data.logic, UPDATE_SETS_SOLID_TO, value);
		}

		void set_updateAffectsFrame(boolean value) {
			Bits::setBit(data.logic, UPDATE_AFFECTS_FRAME, value);
		}

		void set_updateSetsFrameTo(boolean value) {
			Bits::setBit(data.logic, UPDATE_SETS_FRAME_TO, value);
		}

		void set_updateAffectsAnimated(boolean value) {
			Bits::setBit(data.logic, UPDATE_AFFECTS_ANIMATED, value);
		}

		void set_updateSetsAnimatedTo(boolean value) {
			Bits::setBit(data.logic, UPDATE_SETS_ANIMATED_TO, value);
		}

		void set_updateReplacesWithGameObject(boolean value) {
			Bits::setBit(data.logic, UPDATE_DISPLACES, value);
		}

		void set_updateReplacesWithGameObjectId(u8 value) {
			Bits::setBits(data.logic, UPDATE_DISPLACES_WITH_ID, objectIdSize, value);
		}

		void set_updateAffectsMovementType(boolean value) {
			Bits::setBit(data.logic, UPDATE_AFFECTS_MOVEMENT_TYPE, value);
		}

		void set_updateSetsMovementTypeTo(u8 value) {
			Bits::setBits(data.logic, UPDATE_SETS_MOVEMENT_TYPE_TO, VALUES_4, value);
		}
};
